<template>
  ...
  >
    ...
    <g-image v-bind="$attrs"/>
  </div>
</template>
<script>
// pretty much the same as here, but with the img tag swapped out for a g-img
// https://github.com/TahaSh/vue-expandable-image/blob/master/src/ExpandableImage.vue
export default {
  props: {
